...
SELECT DISTINCT compania FROM Usuarios ORDER BY RAND(compania); 
...
SELECT DISTINCT(marca) FROM Usuarios ORDER BY RAND(marca);
...
SELECT usuario, telefono FROM Usuarios WHERE NOT marca IN("MOTOROLA", "NOKIA");
